...
public class PatternMatcher {
	...
	public static void main(String[] args) {
		String ms4 = "Aug 16 07:19:53 server2222.xxx.comLogfileMonitor|15028855393|server1|critical|Logfile|OS|openView-6800.log|Wed Aug 19 07:19:01 2017|critical|Tomcat is not responsive; Solr service will be affected. Restart Solr if the problem persists.|LogfileMonitor";
